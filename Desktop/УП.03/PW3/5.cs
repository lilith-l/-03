...
namespace PW3_2
{
    internal class Program
    {
        ...
        {
            SmsMessage sms = new SmsMessage("РСЧС: 21.02.23 на территории области ожидается мокрый снег, на дорогах местами снежные заносы. Порывы ветра до 17 м/с. Тел: 112.", 100, 2, 0.9);
            sms.SendMessage();
